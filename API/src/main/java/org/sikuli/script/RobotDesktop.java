...
public class RobotDesktop extends Robot implements IRobot {
    ...
    public void smoothMove(Location src, Location dest, long ms) {
        ...
        Animator aniX = new AnimatorTimeBased(new AnimatorOutQuarticEase(src.x, dest.x, ms));
        Animator aniY = new AnimatorTimeBased(new AnimatorOutQuarticEase(src.y, dest.y, ms));
        float x = 0, y = 0;
        while (aniX.running()) {
            x = aniX.step();
            y = aniY.step();
